...
def banner():
	...
	prints(Panel(f"""
{M2} ⣠⣴⣶⣶⣶⣶⣶⣶⣶⣶⣦⣄   {R3}___           _           _       _ _ {P2}              
{M2} ⣿⣿⣿⡿⠛⢉⡉⠛⢿⣤⣼⣿  {R3}|_ _|_ __  ___| |_ __ _   / \   __| | |_ _   _  __ _ {P2}
{K2} ⣿⣿⡏⢠⣾⣿⣿⣷⡄⢹⣿⣿   {R3}| || '_ \/ __| __/ _` | / _ \ / _` | __| | | |/ _` |{P2}
{K2} ⣿⣿⣇⠘⢿⣿⣿⡿⠃⣸⣿⣿   {R3}| || | | \__ \ || (_| |/ ___ \ (_| | |_| |_| | (_| |{P2}
 {H2}⣿⣿⣿⣷⣤⣈⣁⣤⣾⣿⣿⣿  {R3}|___|_| |_|___/\__\__,_/_/   \_\__,_|\__|\__, |\__,_|{P2}
 {H2}⠙⠻⠿⠿⠿⠿⠿⠿⠿⠿⠟⠋                                           {R3}|___/{P2}
\t           {R2}Brute Force Instagram By Xyaa Code """,title=f"{B2}{waktu()}",width=80,padding=(0,4),style=f"#FFFFFF"))

def loading():
    animation = ["[\x1b[1;91m■\x1b[0m□□□□□□□□□]","[\x1b[1;92m■■\x1b[0m□□□□□□□□]", "[\x1b[1;93m■■■\x1b[0m□□□□□□□]", "[\x1b[1;94m■■■■\x1b[0m□□□□□□]", "[\x1b[1;95m■■■■■\x1b[0m□□□□□]", "[\x1b[1;96m■■■■■■\x1b[0m□□□□]", "[\x1b[1;97m■■■■■■■\x1b[0m□□□]", "[\x1b[1;98m■■■■■■■■\x1b[0m□□]", "[\x1b[1;99m■■■■■■■■■\x1b[0m□]", "[\x1b[1;910m■■■■■■■■■■\x1b[0m]"]
    for i in range(50):
        time.sleep(0.1)
        sys.stdout.write(f"\r{P}[{M}!{P}] verifikasi data... " + animation[i % len(animation)] +"\x1b[0m ")
        sys.stdout.flush()
    print("")		
				...
				try:
					...
					if "logged_in_user" in str(xyaaXD) or "sessionid" in ses.cookies.get_dict():
						...
						try:
							...
							print('\n')
							cetak(nel(pepekXD,style='',title='\r[green]AdtyaLive[white]'))
						...
						print('\n')
						cetak(nel(pepekXD,style='', title='\r[yellow]AdtyaCepe[white]'))
